...
{
    public class BeforeTextStrategy : AbstractEmojifyStrategy
    {
        public BeforeTextStrategy(IEmojiContainer emojiProvider) : base(emojiProvider) { }
        ...
        public override string Emojify(string text, int minimumCharacters = 0)
        {
            ...
            return stringBuilder.Length == 0 ? text : stringBuilder.ToString() + " " + text;
        }
    }
}
